...
export class FtAssessmentQueryDto {
  @IsOptional()
  @IsString()
...
export class FtAssessmentListDto {
  take: number;
...
export class SendFtAssessmentFinalEmailDto {
  @IsNotEmpty()
  @IsNumber({}, { each: true })
  @ApiProperty({
    required: true,
  ...
  @ApiProperty({
    required: true,
    type: Number,
    description: 'foundationTrainingLevel',
    example: 1
  })
